...
import io.github.aliothliu.rbac.domain.ValidationHandler;
import io.github.aliothliu.rbac.domain.Validator;
...
public class PageElementsValidator extends Validator<Set<String>> {
    ...
    public void validate(Set<String> elements) {
        ...
        Optional<Page> pageOptional = RbacRegistry.pageRepository().findById(this.pageId);
