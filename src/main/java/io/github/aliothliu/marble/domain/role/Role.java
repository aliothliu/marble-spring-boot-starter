...
import io.github.aliothliu.marble.domain.Identity;
...
import io.github.aliothliu.marble.domain.page.ElementId;
...
@Entity
@Table(name = "#{marbleProperties.jpa.roleTableName}")
@Getter
@FieldNameConstants
public class Role extends AssertionConcern implements Serializable {
    ...
    public void validate() {
        this.assertArgumentFalse(MarbleRegistry.roleRepository().existsByCode(this.code), "不允许重复的角色编码[" + code.getCode() + "]");
    }
    ...
    private ElementRepository elementRepository() {
        return MarbleRegistry.elementRepository();
    }
}
