package io.github.aliothliu.marble.interfaces;

import io.github.aliothliu.marble.application.RbacMenuService;
import io.github.aliothliu.marble.application.command.ChangeMenuCommand;
import io.github.aliothliu.marble.application.command.NewMenuCommand;
...
@RestController
@RequestMapping("/#{marbleProperties.web.prefix}/menus")
