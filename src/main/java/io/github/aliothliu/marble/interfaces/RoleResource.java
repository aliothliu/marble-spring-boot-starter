...
import io.github.aliothliu.marble.application.RoleApplicationService;
import io.github.aliothliu.marble.application.RoleQueryService;
...
@RestController
@RequestMapping("/#{marbleProperties.web.prefix}/roles")
